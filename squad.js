...
function createControlsContainer() {
  // Create a container for all control buttons (pause/resume, sound, settings)
  controlsContainer = createDiv("");
  controlsContainer.id("controls-container");
  controlsContainer.position(width - 240, 10); // Position in the top right corner
  controlsContainer.style("display", "flex");
  ...
  // Initially hide the container if we're in menu or game over state
...
function createSettingsElement() {
  ...
  settingsContainer.id("settings-button");
  settingsContainer.class("control-button");
  settingsContainer.style("background-color", "rgba(50, 50, 50, 0.8)");
  settingsContainer.style("border-radius", "5px");
  settingsContainer.style("padding", "10px");
  settingsContainer.style("width", "40px");
  settingsContainer.style("height", "40px");
  settingsContainer.style("cursor", "pointer");
  settingsContainer.style("display", "flex");
  settingsContainer.style("align-items", "center");
  settingsContainer.style("justify-content", "center");
  ...
  settingsContainer.mousePressed(openSettings);
  
  // Add to controls container
  controlsContainer.child(settingsContainer);
}
